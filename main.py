...
if Popen(sc query "AntiCheatExpert Service" | find /c "FAILED")!=0:
  Popen(f'sc create "Wurthering_Wave_Close_service" binpath = "{os.getcwd()}/main.exe" start= auto displayname = "鳴潮自動停止ACE服務"')
  Popen('sc start "Wurthering_Wave_Close_service"')
